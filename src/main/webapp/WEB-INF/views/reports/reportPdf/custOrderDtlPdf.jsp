...
<body>
					<div class="no-break">
							...
							style="text-align: center; font-size: 18px; margin-top: 20px; margin-bottom: 5px;">
								...
								<h3
									style="color: #000; text-align: center; margin: 0px;">Order Report</h3>
							</div>
				...
				style="border-top: 1px solid #313131;" class="table datatable-header-basic">
					...
					<c:forEach items="${custRepList}" var="order" varStatus="count">
							<tr>
								<td width="5%">${srno}</td>
								<td width="12%" style="text-align: left;">${order.custName}</td>
								<td width="8%" style="text-align: center;">${order.custMobileNo}</td>
								<td width="20%" style="text-align: center;">${order.dateOfBirth}</td>							
								<td width="20%" style="text-align: right;">${order.grandTotal}</td>									
							</tr>
