...
<body>
					<div class="no-break">
							...
							style="text-align: center; font-size: 18px; margin-top: 20px; margin-bottom: 5px;">
								...
								<h3
									style="color: #000; text-align: center; margin: 0px;">Date Wise Customer Bill Detail</h3>
							</div>
				...
				style="border-top: 1px solid #313131;" class="table datatable-header-basic">
					...
					<c:forEach items="${order}" var="order" varStatus="count">
							<tr>
								<td width="5%">${srno}</td>
								<td width="10%" style="text-align: center;">${order.invoiceNo}</td>
								<td width="10%" style="text-align: right;">${order.billDate}</td>
								<td width="15%" style="text-align: right;">${order.grandTotal}</td>								
								<td width="15%" style="text-align: right;">${order.paymentMode == 1 ? 'Cash' : order.paymentMode == 2 ? 'Card' : 'E-Pay' }</td>								
								<td width="15%" style="text-align: right;">${order.delvrBoyName}</td>						
							</tr>
					...
					<tr>
						...
						<td width="20%"
							style="font-weight: bold; border-bottom: 1px solid #313131; border-bottom: 1px solid #313131; border-left: 1px solid #313131; padding: 5px; color: #000; font-size: 15px; text-align: right;">
